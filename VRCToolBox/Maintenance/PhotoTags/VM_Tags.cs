...
{
    public class VM_Tags : VM_DataMaintenanceOneRelation<DataModelBase<PhotoTag>, DataModelBase<PhotoData>>
    {
        public VM_Tags() : this(new DBOperator()) { }
        public VM_Tags(IDBOperator dBOperator) : this(new DataAccessorOneRelation<DataModelBase<PhotoTag>, DataModelBase<PhotoData>>(dBOperator)) { }
