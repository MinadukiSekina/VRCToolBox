...
namespace VRCToolBox.Maintenance.Avatars
{
    public class VM_Avatars : VM_DataMaintenanceWithAuthor<DataModelWithAuthor<Data.AvatarData>>
    {
        ...
        public VM_Avatars(IDBOperator dBOperator) : this(new DataAccessor<DataModelWithAuthor<Data.AvatarData>>(dBOperator)) { }
        public VM_Avatars(IDataAccessor<DataModelWithAuthor<Data.AvatarData>> dataAccessor) : base(dataAccessor) { }
    }
}
