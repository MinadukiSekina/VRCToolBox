...
namespace VRCToolBox.Pictures.ViewModel
{
    public class PhotoExploreViewModel : ViewModelBase
    {
        ...
        public PhotoExploreViewModel()
        {
            ...
            SearchVisitedWorldByDateAsyncCommand.AddTo(_compositeDisposable);
            ...
            AddToHoldPhotosCommand.AddTo(_compositeDisposable);
            RemovePhotoFromHoldPhotosCommand.AddTo(_compositeDisposable);
            RemoveAllPhotosFromHoldPhotosCommand.AddTo(_compositeDisposable);
        }
    }
}
