...
namespace VRCToolBox.Settings
{
    internal static class ProgramConst
    {
        ...
        public static readonly string DefaultProjectBackupsDirectory = $@"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\{nameof(VRCToolBox)}\ProjectBackups";
